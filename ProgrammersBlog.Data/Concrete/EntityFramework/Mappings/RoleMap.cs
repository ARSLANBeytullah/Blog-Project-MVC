...
namespace ProgrammersBlog.Data.Concrete.EntityFramework.Mappings
{
    public class RoleMap : IEntityTypeConfiguration<Role>
    {
        public void Configure(EntityTypeBuilder<Role> builder)
        {
            ...
            builder.HasData(new Role //Tam veri tabanı oluşurken bu veriler oluşacak. Bu bilgileri girerken migration tarafın da hata almamak için bilgileri eksiksiz girmemiz gerekmektedir.Null geçilebilir alanlar dahi doldurulmalıdır.
            { 
                Id = 1,
                Name = "Admin",
