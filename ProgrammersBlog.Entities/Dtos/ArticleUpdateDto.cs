...
namespace ProgrammersBlog.Entities.Dtos
{
    public class ArticleUpdateDto
    {
        ...
        [DisplayName("Başlık")]   //Data annotation
        ...
        [DisplayName("Silinsin mi?")]   //Data annotation //Burada son kullancıya Title değil de Başlık olarak görünmesini istediğimizden DisplayName[("Başlık")] yazdık.
        [Required(ErrorMessage = "{0} alanı boş geçilmemelidir.")]
